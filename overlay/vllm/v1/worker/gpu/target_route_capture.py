...
# Unknown VLLM_* variables are deliberately stripped before vLLM spawns GPU
# workers. Keep diagnostic controls in the project namespace so the model
# runner, rather than only the API process, receives them.
CAPTURE_ENV = "DSPARK_TARGET_ROUTE_CAPTURE"
