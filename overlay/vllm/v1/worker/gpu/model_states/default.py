    ...
    def prepare_attn(
        ...
        if (
            ...
            req_doc_ranges = compute_mm_prefix_ranges(
                ...
                clamps_in_kernel=getattr(
                    self.model_config.hf_config, "mm_prefix_clamp_sliding_window", False
                ),
                span_leading_pad_modulus=getattr(
                    self.model_config.hf_config, "mm_prefix_span_leading_pad_modulus", 0
                ),
            )
